      ...
      <main className="p-4">
        <div className="mb-6">
          ...
          <section className="prose mx-auto max-w-none text-center sm:text-left">
            <h2 className="text-2xl font-semibold text-black dark:text-zinc-50">Laporan Keuangan UC</h2>
            <p className="text-zinc-600 dark:text-zinc-400">Buat laporan keuangan kunjungan UC</p>
          </section>
        </div>
